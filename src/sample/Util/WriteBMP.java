...
public class WriteBMP {
    ...
    private BufferedImage getBMP(BMPData bmpData, RescaleType rescaleType) throws IOException{
        int[][] r;
        int[][] g;
        int[][] b;
    ...
    public void printBMP(BMPData bmpData, RescaleType rescaleType) throws IOException{
        if(bmpData.isSizeEqual()){
            BufferedImage img = getBMP(bmpData, rescaleType);
        ...
        System.out.println("Finished " + bmpData.getImageName());
    }

    public BufferedImage getBufferedImage(BMPData bmpData, RescaleType rescaleType) throws IOException{
        return getBMP(bmpData, rescaleType);
    }
